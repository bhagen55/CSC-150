/**
 * Class representing a times sign
 * 
 * @author Blair Hagen
 * @version 5-19-2016
 *
...
public class Times implements Token {
    ...
    private final int DEFAULT_PRECEDENCE = 2; //precedence of this sign in relation to other operators
    private final String DEFAULT_STRING = "*";
    
    /**
     * Default Constructor
     * sets string and precedence to default values of * and 2
     */
    public Times() {
