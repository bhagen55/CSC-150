/**
 * Class representing an Exponent
 * 
 * @author Blair Hagen
 * @version 5-19-2016
 *
...
public class Exponent implements Token {
    ...
    private final int DEFAULT_PRECEDENCE = 3; //precedence of this sign in relation to other operators
    private final String DEFAULT_STRING = "^";
    
    /**
     * Default Constructor
     * sets string and precedence to default values of ^ and 3
     */
    public Exponent() {
