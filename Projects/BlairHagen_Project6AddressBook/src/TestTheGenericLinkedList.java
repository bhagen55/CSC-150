public class TestTheGenericLinkedList {
  ...
  private static void testRemoveContact() {
	  ...
	  l1.remove(p3);
	  Testing.assertEquals("Remove from start of list", "{Bobama, Dell, Nell, Obama, Opell}", l1.toString());
	  Testing.assertEquals("Length changes", 5, l1.getLength());
	  
	  l1.remove(b2);
	  Testing.assertEquals("Remove from middle of list", "{Bobama, Dell, Obama, Opell}", l1.toString());
	  Testing.assertEquals("Length changes", 4, l1.getLength());
	  
	  l1.remove(b3);
	  Testing.assertEquals("Remove from end of list", "{Bobama, Dell, Obama}", l1.toString());
	  Testing.assertEquals("Length changes", 3, l1.getLength());
  }
