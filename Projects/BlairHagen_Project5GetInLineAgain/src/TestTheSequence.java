...
public class TestTheSequence {
	...
	private static void testAdvance() {
		...
		Testing.assertEquals("Check that current is null", null, s1.getCurrent());
	}
	...
	private static void testEquals() {
		...
		s5.addAfter("E");
		s5.addAfter("G");
		Testing.assertEquals("Compare sequences with last element differing", false, s4.equals(s5));
		
		Sequence s6 = new Sequence();
		Sequence s7 = new Sequence();
		Testing.assertEquals("Compare two empty sequences", true, s6.equals(s7));
	}
}
